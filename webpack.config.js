...
let config = {
  ...
  output: {
    ...
    filename: process.env.NODE_ENV !== 'development' ? 'assets/js/[id].[chunkhash:8].js' : '[name].js'
  ...
  plugins: [
    ...
    new ExtractTextPlugin({
      filename: process.env.NODE_ENV !== 'development' ? 'assets/css/[id].[contenthash:8].css' : '[name].css',
      allChunks: true
    })
